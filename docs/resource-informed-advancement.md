...
| 6 | Deliver one contracted completed-file sensor adapter | Start from the existing Suricata EVE contract and the live dependency gates. No generic executor or provider-console embedding is introduced. |
