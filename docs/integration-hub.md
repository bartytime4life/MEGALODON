...
| `local-ai-advisory` | Qwen via local Ollama | Optional internal adapter | One explicit Airlock-admitted request to literal `127.0.0.1:11434`; no CLI/dashboard route, raw traffic, proxy/DNS/redirect, background analysis, persistence, tools, or action authority |
