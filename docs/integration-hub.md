...
| `local-ai-advisory` | Qwen via local Ollama | Optional explicit Linux adapter | One sealed ADMIT to literal `127.0.0.1:11434/api/generate`; no proxy, DNS, redirect, background analysis, traffic inspection, tool, or action authority |
