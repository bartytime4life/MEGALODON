...
_WORKFLOWS = (
    ...
    },
    {
        ...
        "input_contract": "megalodon-suricata-eve-alert-input-v1 envelope",
    ...
    },
    {
        ...
        "output_contract": "planned/applied/failed ActionRecord",
        "entry_point": "megalodon firewall-plan, firewall-install, or block",
        "launch_policy": "plan_first_explicit_confirmation",
        "data_boundary": "validated target and fixed nftables argv only",
        "action_boundary": "no sudo; apply requires already-held root, exact confirmation, and finite expiry",
        "next_gate": "disposable-namespace rollback and firewall-owner conflict tests",
    },
    {
        "id": "manual-file-scan",
        "component": "clamav",
