...
_WORKFLOWS = (
    ...
    },
    {
        ...
        "input_contract": "intact sealed AirlockDecision ADMIT",
        "output_contract": "immutable display-only AdvisoryReceipt",
        "entry_point": "megalodon.advisory_provider.request_advisory",
        "launch_policy": "explicit_call_literal_ipv4_loopback_only",
        "data_boundary": "canonical metadata prompt only; no raw traffic, proxy, DNS, background feed, or Internet access",
        "action_boundary": "model output cannot execute commands, modify the host, or apply a response",
        "next_gate": "separately reviewed read-only projection into the Deep analysis and context panel",
    },
    {
