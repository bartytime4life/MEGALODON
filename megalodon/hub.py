...
_WORKFLOWS = (
    ...
    },
    {
        ...
        "integration_owner": "megalodon.advisory_provider",
        "input_contract": "Airlock-admitted local-model-advisory-v1 request and pinned one-entry registry",
        "output_contract": "advisoryInvocationReceipt with provenance, limitations, and request-boundary status",
        "entry_point": "Python API: megalodon.advisory_provider.invoke_local_advisory",
        "launch_policy": "explicit_opt_in_literal_loopback_only",
        "data_boundary": "canonical bounded metadata prompt only; no raw traffic, payload, packet capture, background feed, proxy, DNS, redirect, or Internet access",
        "action_boundary": "model output cannot execute commands, modify the host, or apply a response",
        "next_gate": "operator-bound real model alias/artifact receipt, native compatibility, and separately reviewed read-only dashboard projection",
    },
    {
