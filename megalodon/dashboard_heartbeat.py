...
function installDisabledReason(mine, running) {
  // A button disabled because it is itself the running job already says so
  // in its own text ("Installing…"/"Starting…"); no separate reason needed.
