"""Explicit schema initialization for the local Suricata durable store.

This module reserves and validates storage only.  It intentionally exposes no
consumer, alert-write, replay, migration, or dashboard API.
"""
